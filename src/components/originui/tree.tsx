...
function TreeItem<T = any>({
  ...
  // Always keep items open (expanded)
  ...
  return (
    <TreeContext.Provider value={{ indent, currentItem: item }}>
      <Comp
        ...
        aria-expanded={alwaysExpanded}
        // Remove any onClick or toggle logic for expand/collapse
        {...otherProps}
      >
        {children}
      </Comp>
...
function TreeItemLabel<T = any>({
  ...
  // Always show chevron down icon for folders, but do not allow toggling
  return (
    <span
